       ...
       return  (
                <div className="form-bottom">
                       <div className="row">
                            <div className="form-group col-sm">
                               ...
                               <input type="text" className="form-control" id="inputOrganization"
                                      ...
                                      ref="organizationname" name="organizationname" onChange={InputChange} required/>
                       ...
                       <div className="row">
                          ...
                          <div className="form-group col-sm">
                            <label htmlFor="inputWebsite" id="websiteLabel">Website</label>
                            <input type="url" className="form-control" id="inputWebsite"
                                   placeholder="Website" defaultValue={user.website}
                                   ref="website" name="website" onChange={InputChange} />
                            <div className="error" id="websiteError"></div>
                          </div>
                       </div>
                       <div className="row">
...
const step3 = (user, handleInputChange, DropDownChange, props) => {
       return (
          <div className="form-bottom">
            ...
            <div className="row">
               <div className="form-group col-sm">
                 <label htmlFor="typeAheadWorkAreas" id="workAreasLabel">Areas worked in</label>
            ...
            <div className="row">
               <div className="form-group col-sm">
                 <label htmlFor="typeAheadCertifications" id="certificationsLabel">Certifications/ Licenses</label>
            ...
            <div className="row">
               <div className="form-group col-sm">
                 <label htmlFor="typeAheadAwards" id="awardsLabel">Awards/ Achievements</label>
            ...
            <div className="row">
               <div className="form-group col-sm">
                 <label htmlFor="typeAheadKeywords" id="keywordsLabel">
...
export const organizationdefs = (props?) => {
  return  [
            {state: 1, title: 'About the organization?', iconClass: 'fa fa-id-card', 
                       render: step1.bind(this), 
                       props: props
             },
            {state: 2, title: 'What is it looking for?', iconClass: 'fa fa-bullseye', render: step2.bind(this), props:props},
            {state: 3, title: 'Why choose this organization?', iconClass: 'fa fa-bullhorn', render: step3.bind(this), props: props}
        ];
}